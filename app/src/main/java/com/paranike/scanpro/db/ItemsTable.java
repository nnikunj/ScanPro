...
public class ItemsTable {
    ...
    public static final String[] ALL_COLUMNS = {
            ...
            COLUMN_SAP_CODE, //
            COLUMN_TOOL_NAME, //
            COLUMN_TOOL_BATCH_NUMBER, //
            COLUMN_GRN_NUMBER, //
            COLUMN_BATCH_NUMBER_RM, //
            COLUMN_INSP_LOT_NUMBER, //
            COLUMN_QUANTITY, //
            COLUMN_SCAN_LOCATION, //
            COLUMN_IS_RPT_GENRATED, //
            COLUMN_TIME_STAMP_STR_FORMAT, //
            COLUMN_SCANNED_BY_USER //
    };
    ...
    public static final String[] DROP_INDICES = {
            "DROP INDEX IF EXISTS "+TABLE_ITEMS+"_"+COLUMN_ID+"_idx ;",
            "DROP INDEX IF EXISTS "+TABLE_ITEMS+"_"+COLUMN_SAP_CODE+"_idx ;"
